...
<body data-spy="scroll" data-target="#menu" data-offset="100">
    ...
    <div id="boxes">
        <div id="dialog" class="window">
            <center>
                <div class='fb-page' data-href='https://www.facebook.com/ian.optimis/' data-tabs='timeline' data-width='500' data-height='355' data-small-header='false' data-adapt-container-width='true' data-hide-cover='false' data-show-facepile='true'><blockquote cite='https://www.facebook.com/ian.optimis/' class='fb-xfbml-parse-ignore'><a href='https://www.facebook.com/ian.optimis/'>Ian Fatah</a></blockquote></div>
            </center><br>
        </div>
        <div id="mask"></div>
    </div>
